...
from flaskcapture.models import Note
from flaskcapture.forms import NoteForm
from flaskcapture import db
...
def home():
    ...
    return render_template('index.html',title='Note List', year=datetime.now().year, notes = notes)
